...
# Load data
data = pd.read_csv(r'/home/grads/sanchit23/bn/Admission_Predict_Ver1.1.csv')  # Replace with your actual file path# Load data
...
for gre_bins in gre_bins_list:
    for toefl_bins in toefl_bins_list:
        for gpa_bins in gpa_bins_list:
            ...
            best_model = hc.estimate(scoring_method=K2Score(train_data_resampled))
...
# Save results to CSV
results_df.to_csv('learned_bn_model_results_with_smote.csv', index=False)
print("\nResults saved to 'learned_bn_model_results_with_smote.csv'")
